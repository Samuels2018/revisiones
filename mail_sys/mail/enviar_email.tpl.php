	...
	<section class="content">
		...
		<div class="row"><!--onSubmit="return deshabilitarBoton();" -->
			<form id="enviar_correo" action="<?php echo ENLACE_WEB; ?>mail_sys/mail/enviar_email_logico.php" method="POST">
				...
				<input type="hidden" name="opcion" value="<?php echo $tipo; ?>" />
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<div class="form-group">
								Destinatario: <input class="form-control" name="para" placeholder="Para:" value="<?php echo $Documento->fk_tercero_email; ?>" />
							</div>
                    ...
                    <?php echo $texto; ?>
							...
							<div class="form-group">
								...
								<table style="width:100%;">
									<tr>
										<td>
											<input type="checkbox" name="pdf_adjunto_disabled" checked value='1' disabled readonly>
            									<input type="hidden" name="pdf_adjunto" value="1">
										</td>
										<td>Documento <?php echo $Documento->documento_txt['singular']; ?> PDF</td>
									</tr>
									<?php if($tipo == 'Factura'){ ?>

									<!-- <tr>
										<td><input type="checkbox" name="xml_factura" checked value='1'></td>
										<td>Documento XML <?php echo $Documento->documento_txt['singular']; ?></td>
									</tr>

									<tr>
										<td><input type="checkbox" name="xml_respuesta" checked value='1'></td>
										<td>Documento XML <?php echo $Documento->documento_txt['singular']; ?> Respuesta</td>
									</tr> -->
									<?php } ?>
