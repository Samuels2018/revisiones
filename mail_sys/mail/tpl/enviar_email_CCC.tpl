...
require_once(ENLACE_WEB."mod_cuentas_cobrar/object/cxc.object.php");
...
<input type="hidden" name="id" 	   value="<?php echo $_REQUEST['idCliente']?>" />
 ...
 <div class="col-md-9">
                  ...
                  <div class="form-group">
                    Detalle: <textarea id="compose-textarea" class="form-control" style="height: 300px;font-family: arial;font-size:10pt;" name="texto">
                     ...
                     <table class="table  table-striped" style="font-family: arial;font-size:10pt;" width="70%" border="0">
                     	<thead>
                     		<tr>
                     			<td colspan="6" style="background-color: transparent;"><img src="<?php echo ENLACE_WEB; ?>bootstrap/images/logoSourcing_blanco.png" width="40%"></td>
                     		</tr>
                     		<tr>
                     			<th colspan="6" style="text-align: left;">ESTADO DE CUENTA</th>
                     		</tr>
                     		<tr style="border: none;">
                     			<th colspan="2" style="border: none;text-align: left;">CLIENTE</th>
                     			<td colspan="4" style="border: none;text-align: left;"><?php echo $ArrayTerceroNombre;?></td>
                     		</tr>
                     		<tr style="border: none;">
                     			<th colspan="2" style="border: none;text-align: left;">FECHA</th>
                     			<td colspan="4" style="border: none;text-align: left;"><?php echo fecha_hoy();?></td>
                     		</tr>
                     		<tr  style="background-color: #CCC">
                     		<th scope="col" style="text-align: center;" width="20%">FACTURA</th>
                     		<th scope="col" style="text-align: center;" width="20%">FECHA</th>
                     		<th scope="col" style="text-align: center;" width="20%">USD</th>
                     		<th scope="col" style="text-align: center;" width="20%">CRC</th>
                     		<th scope="col" style="text-align: center;" width="20%">VENCIMIENTO</th>
                     	</tr>
                     	</thead>
                    <tbody>
        ...
        <p style="font-family: arial;font-size:10pt;">Su pago electrónico por favor efectuarlo a la siguiente cuenta:<br>
                      ...
                      Cordialmente</p>
					   <?php } else{ ?>
              <p style="font-family: arial;font-size:10pt;">Dear Customer, 
                      <br><br><br>
                     ...
                     <table class="table  table-striped" style="font-family: arial;font-size:10pt;" width="70%" border="0">
                      <thead>
                        ...
                        <tr style="border: none;">
                          <th colspan="2" style="border: none;text-align: left;">COSTUMER</th>
                          <td colspan="4" style="border: none;text-align: left;"><?php echo $ArrayTerceroNombre;?></td>
                        </tr>
                        <tr style="border: none;">
                        ...
                        <tr  style="background-color: #CCC">
                        <th scope="col" style="text-align: center;" width="20%">INVOICE</th>
                        <th scope="col" style="text-align: center;" width="20%">DATE</th>
                        <th scope="col" style="text-align: center;" width="20%">USD</th>
                        <th scope="col" style="text-align: center;" width="20%">CRC</th>
                        <th scope="col" style="text-align: center;" width="20%">DUE DATE</th>
                      </tr>
                      </thead>
                    <tbody>
        ...
        <p style="font-family: arial;font-size:10pt;">See below the bank details:<br>
                    ...
                    <?php } ?>
                    <br><br>
                    <img src="<?php echo ENLACE_WEB; ?>bootstrap/images/firmaCorreo.png" width="40%">
                    </textarea>
                  </div>
