...
require_once(ENLACE_SERVIDOR."mod_cuentas_cobrar/object/cxc.object.php");
$clientes = new CXC($dbh);
$clientes->id = $_GET['idCliente'];
$cliente=$clientes->fetch();
$ids="0";
$asunto_clientes='';
$clientes_nombre='';
$i=0;
  foreach ($cliente as $cxc) {
    $guion=' - ';
    if($i==0){$guion='';}
    $ids.=",".$cxc['id'];
    $asunto_clientes.=$guion.$cxc['nombre'];
    $clientes_nombre.=$cxc['nombre'].'<br>';
    $i++;
  }
  $ids.="";
 function fecha_hoy(){
...
$sql= "select  *  from sistema_tipo_cambio order by rowid DESC   "  ; 
   ...
   $sql= "select   
            ...
            while ($dato = $db->fetch(PDO::FETCH_OBJ)){ 
                ...
                $email_explode=explode(",", $dato->email);
                foreach ($email_explode as $value) {
                  $email[$value]=$value;
                }
                ...
                if($dato->email_tramitador==''){}
                else{
                  //$extra[$dato->email_tramitador]=$dato->email_tramitador;
                  $email_tramita=explode(",", $dato->email_tramitador);
                  foreach ($email_tramita as $value) {
                    $extra[$value]=$value;
                  }
                $x++;}
                if($dato->email_contador==''){}
                  else{
                    //$extra[$dato->email_contador]=$dato->email_contador;
                    $email_conta=explode(",", $dato->email_contador);
                    foreach ($email_conta as $value) {
                      $extra[$value]=$value;
                    }
                $x++;}
            //}
...
$asunto="SOA S&L COORPORATIVO  - ".fecha_hoy(); 
...
<input type="hidden" name="id" 	   value="<?php echo $_REQUEST['idCliente']?>" />
 ...
 <div class="col-md-9">
              <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    Destinatario: <input class="form-control"   name="para" placeholder="Para:" value="<?php echo $emails; ?>"/>
                  </div>

 

                  <div class="form-group">
                    CC: <input class="form-control" placeholder="CC:" name="cc" value="<?php echo $extras;?>"/>
                  </div>
                  ...
                  <div class="form-group">
                    Detalle: <textarea id="compose-textarea" class="form-control" style="height: 300px;font-family: arial;font-size:10pt;" name="texto">
                      ...
                      <p style="font-family: arial;font-size:10pt;"><b>Estimados (as):</b> <br><?php echo $clientes_nombre;?>
                      <br><br>
                     ...
                     <table class="table  table-striped" style="font-family: arial;font-size:10pt;" width="70%" border="0">
                     	<thead>
                     		...
                     		<tr style="border: none;">
                     			<th colspan="" style="border: none;text-align: left;vertical-align: top;">CLIENTES</th>
                     			<td colspan="5" style="border: none;text-align: left;"><?php echo $clientes_nombre;?></td>
                     		</tr>
                     		<tr style="border: none;">
        ...
        <br><br>
        <p style="font-family: arial;font-size:10pt;">Su pago electrónico por favor efectuarlo a la siguiente cuenta:<br><br>
                      ...
                      Cordialmente</p>
					   <?php } else{ ?>
              <p style="font-family: arial;font-size:10pt;"><b>Dear Customers: </b> <br><?php echo $clientes_nombre;?> 
                      <br><br><br><br>
                     ...
                     <table class="table  table-striped" style="font-family: arial;font-size:10pt;" width="70%" border="0">
                      <thead>
                        <tr>
                          <td colspan="6" style="background-color: transparent;"><img src="<?php echo ENLACE_WEB; ?>bootstrap/images/logoSourcing_blanco.png" width="30%"></td>
                        </tr>
                        <tr>
                          <th colspan="6" style="text-align: left;">STATEMENT OF ACCOUNT </th>
                        </tr>
                        <tr style="border: none;">
                          <th colspan="2" style="border: none;text-align: left;vertical-align: top;">COSTUMERS</th>
                          <td colspan="4" style="border: none;text-align: left;"><?php echo $ArrayTerceroNombre;?></td>
                        </tr>
                        <tr style="border: none;">
                          <th colspan="2" style="border: none;text-align: left;">DATE</th>
                          <td colspan="4" style="border: none;text-align: left;"><?php echo fecha_hoy();?></td>
                        </tr>
                        <tr  style="background-color: #CCC">
